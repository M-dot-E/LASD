...
template <typename Data>
BST<Data>::NodeLnk*& BST<Data>::FindPointerTo(BST<Data>::NodeLnk*& node, const Data& dato) noexcept {
    return const_cast<BST<Data>::NodeLnk*&>(static_cast<const BST<Data> *>(this)->FindPointerTo(node, dato));
}


template <typename Data>
BST<Data>::NodeLnk** BST<Data>::FindPointerToPredecessor(BST<Data>::NodeLnk*& node, const Data &dato) noexcept {
    return const_cast<NodeLnk**>(static_cast<const BST<Data> *>(this)->FindPointerToPredecessor(node, dato));
}


template <typename Data>
BST<Data>::NodeLnk** BST<Data>::FindPointerToSuccessor(BST<Data>::NodeLnk*& node, const Data &dato) noexcept {
